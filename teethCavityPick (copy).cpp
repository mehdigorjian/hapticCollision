...
int main(int argc, char* argv[]) {
    ...
    // Load cube model
    TriMesh* c = new TriMesh("models/TeethCavityPickModels/cube.obj");
    gDentureGum = c;
    c->setName("cube");
    c->setShapeColor(1.0, 0.5, 0.65);
    c->setRotation(hduVector3Dd(1.0, 0.0, 0.0), 45.0);
    c->setStiffness(0.6);
    c->setDamping(0.1);
    c->setFriction(0.5, 0.9);
    DisplayObject->tell(c);  // Tell quickhaptics that cube exists
